                ...
                children: [
                                ...
                                children: [
                                    /*#__PURE__*/ _jsxs("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ _jsx("p", {
                                                className: "text-sm md:text-base text-muted-foreground mt-2 max-w-xl text-pretty",
                                                children: "Building efficient marketing systems that drive measurable results through automation, integration, and process optimization."
                                            })
                                        ]
                                    }),
                                    /*#__PURE__*/ _jsxs("div", {
                            ...
                            /*#__PURE__*/ _jsxs("nav", {
                                ...
                                children: [
                                    /*#__PURE__*/ _jsxs("button", {
                                        ...
                                        className: `pb-3 px-1 font-medium transition-colors relative ${activeTab === "about" ? "text-foreground" : "text-muted-foreground hover:text-foreground"}`,
                                        children: [
                                            "About",
                                            activeTab === "about" && /*#__PURE__*/ _jsx("div", {
                                    ...
                                    /*#__PURE__*/ _jsxs("button", {
                                        ...
                                        className: `pb-3 px-1 font-medium transition-colors relative ${activeTab === "experience" ? "text-foreground" : "text-muted-foreground hover:text-foreground"}`,
                                        children: [
                                            "Experience",
                                            activeTab === "experience" && /*#__PURE__*/ _jsx("div", {
                                                className: "absolute bottom-0 left-0 right-0 h-0.5 bg-foreground"
                                            })
                                        ]
                                    }),
                                    /*#__PURE__*/ _jsxs("button", {
                                        ...
                                        className: `pb-3 px-1 font-medium transition-colors relative ${activeTab === "projects" ? "text-foreground" : "text-muted-foreground hover:text-foreground"}`,
                                        children: [
                                            "Projects",
                                            activeTab === "projects" && /*#__PURE__*/ _jsx("div", {
                                                className: "absolute bottom-0 left-0 right-0 h-0.5 bg-foreground"
                                            })
                                        ]
                                    })
                    ...
                    /*#__PURE__*/ _jsxs("main", {
                        children: [
                            ...
                            activeTab === "experience" && /*#__PURE__*/ _jsx(ExperienceSection, {}),
                            activeTab === "projects" && /*#__PURE__*/ _jsx(ProjectsSection, {})
                        ]
                    }),
                    ...
                    /*#__PURE__*/ _jsxs("div", {
                        ...
                        children: [
                            /*#__PURE__*/ _jsx("p", {
                                ...
                                children: "I'm a marketing operations professional who builds efficient systems that drive measurable results. Over the past 9 years at companies like Benchling, Intercom, and Malwarebytes, I've specialized in marketing automation, system integration, and process optimization."
                            }),
                            /*#__PURE__*/ _jsx("p", {
                                className: "text-base leading-relaxed text-muted-foreground mt-4",
                                children: "My approach centers on transforming complex marketing technology stacks into streamlined operations. I've implemented automated lead nurturing systems that improved conversion efficiency, consolidated vendor tools to achieve significant cost savings, and built comprehensive documentation systems that enable teams to operate more effectively. I'm a Marketo Certified Expert with deep experience across the full marketing operations spectrum."
                            }),
                            /*#__PURE__*/ _jsx("p", {
                                className: "text-base leading-relaxed text-muted-foreground mt-4",
                                children: "Whether it's designing segmentation strategies, integrating CRM platforms, optimizing lead lifecycle management, or creating data health monitoring practices, I focus on building infrastructure that reduces manual work and enables data-driven decision making. My work helps marketing teams move faster, spend smarter, and measure what matters."
                            })
                        ]
                    })
                ]
            ...
            /*#__PURE__*/ _jsxs("section", {
                children: [
                    ...
                    /*#__PURE__*/ _jsx("div", {
                        ...
                        ].map((expertise)=>/*#__PURE__*/ _jsxs("div", {
            ...
            /*#__PURE__*/ _jsxs("section", {
                children: [
                    ...
                    /*#__PURE__*/ _jsx("p", {
                        ...
                        children: "I'm always interested in hearing about new opportunities and connecting with fellow marketing operations professionals. Feel free to reach out."
                    }),
                    /*#__PURE__*/ _jsxs("div", {
...
function ExperienceSection() {
    ...
    return /*#__PURE__*/ _jsx("div", {
        className: "space-y-6",
        children: experiences.map((exp, index)=>/*#__PURE__*/ _jsxs(Card, {
                className: "p-6 hover:border-foreground/20 transition-colors",
                children: [
                    /*#__PURE__*/ _jsxs("div", {
                        className: "flex flex-col md:flex-row md:items-start md:justify-between mb-3 gap-2",
                        children: [
                            /*#__PURE__*/ _jsxs("div", {
                                children: [
                                    /*#__PURE__*/ _jsx("h3", {
                            ...
                            /*#__PURE__*/ _jsx("span", {
                                className: "text-sm text-muted-foreground md:text-right shrink-0",
                                children: exp.period
                            })
                        ]
                    }),
                    /*#__PURE__*/ _jsx("ul", {
                        ...
                        children: exp.highlights.map((highlight, idx)=>/*#__PURE__*/ _jsxs("li", {
                                className: "text-sm leading-relaxed text-muted-foreground flex",
                                children: [
                                    /*#__PURE__*/ _jsx("span", {
                    ...
                    /*#__PURE__*/ _jsx("div", {
                        ...
                        children: exp.technologies.map((tech)=>/*#__PURE__*/ _jsx("span", {
...
function ProjectsSection() {
    const projects = [
        {
            ...
            company: "Benchling",
            description: "Led strategic vendor consolidation initiative, negotiating contracts and streamlining the marketing technology ecosystem. Achieved significant cost savings while improving system performance and team efficiency.",
            tags: [
                "Vendor Management",
                "Cost Optimization",
                "System Integration"
        ...
        },
        {
            ...
            company: "Benchling",
            description: "Developed standardized processes for campaign and channel management, creating automated lead nurturing workflows that enhanced demand generation and improved lead conversion efficiency.",
            tags: [
                "Marketing Automation",
                "Lead Conversion",
                "Process Design"
        ...
        },
        {
            ...
            company: "Intercom",
            description: "Developed sophisticated segmentation strategies and automated campaign workflows including data mapping, user journeys, drip campaigns, and triggered email sequences that significantly improved engagement and conversion rates.",
            tags: [
                "Segmentation",
                "Email Marketing",
                "Workflow Automation"
        ...
        },
        {
            ...
            company: "Malwarebytes",
            description: "Developed and launched the company's first customer nurture program, driving seat usage from 50-60% to 95% through strategic engagement campaigns and personalized content delivery.",
            tags: [
                "Customer Success",
                "Nurture Campaigns",
                "Product Adoption"
        ...
        },
        {
            ...
            company: "Malwarebytes",
            description: "Implemented multiple efficiency tools including LeanData and developed automated processes that dramatically reduced lead-to-conversion times, accelerating pipeline velocity and improving sales team productivity.",
            tags: [
                "Lead Management",
                "Process Automation",
        ...
        },
        {
            ...
            company: "Benchling",
            description: "Established ongoing data health monitoring practices, ensuring accurate and relevant data quality for effective marketing tactics and reliable reporting across all campaigns.",
            tags: [
                "Data Quality",
                "System Monitoring",
                "Process Automation"
    ...
    return /*#__PURE__*/ _jsx("div", {
        ...
        children: projects.map((project, index)=>/*#__PURE__*/ _jsxs(Card, {
                ...
                children: [
                    ...
                    project.impact && /*#__PURE__*/ _jsxs("p", {
                    ...
                    /*#__PURE__*/ _jsx("div", {
                        className: "flex flex-wrap gap-2",
                        children: project.tags.map((tag)=>/*#__PURE__*/ _jsx("span", {

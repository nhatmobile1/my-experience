  ...
  const experiences = [
    {
      ...
      highlights: [
        ...
        "Reducing campaign setup time by 30% through standardized processes and automation",
        "Automating manual processes to free 20% of team capacity for strategic initiatives",
      ],
      technologies: [
        "Marketo",
        "Salesforce",
